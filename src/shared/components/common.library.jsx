...
export const SectionTitle = ({children,className,...rest}) => {
    return <p className={`text-4xl md:text-6xl transition-all font-raleway ${className}`} {...rest}>{children}</p>
}
...
export const TitleLg = ({children,className,...rest}) => {
    return <p className={`text-3xl font-raleway font-light ${className}`} {...rest}>{children}</p>
}

export const TitleMd = ({children,className,...rest}) => {
    return <p className={`text-2xl font-raleway font-light ${className}`} {...rest}>{children}</p>
}

export const TitleSm = ({children,className,...rest}) => {
    return <p className={`text-lg font-raleway ${className}`} {...rest}>{children}</p>
}
