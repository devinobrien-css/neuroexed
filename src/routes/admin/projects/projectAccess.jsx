    ...
    return (
      <div className="editable selected-editable" id={"new-project"}>
        ...
        <div className={state ? "hidden-content open" : "hidden-content"}>
          ...
          <div className="selected-member-list">
            {selectedMembers.map((item, index) => (
              ...
              >
                ...
                />
                <p className="pl-2 my-auto font-light text-xl">
          ...
          <div className="border rounded shrink-0 relative">
            <StandardInput
              title={"Add Members"}
              className={"border px-2"}
              value={newMember}
            ...
            />
            <div className="bg-white absolute flex flex-col z-[100] w-1/3 top-full overflow-scroll min-w-[240px] max-h-[180px] overflow-y-scroll shadow">
              {newMember !== "" ? (
                people
                  .filter(
                    (person) =>
                    ...
                    return (
                      ...
                      >
                        <div className="w-full flex no-wrap">
                          ...
                          />
                          <p className="text-2xl font-light pl-1 my-auto">
              ...
              {newMember !== "" ? (
                people
                  ...
                  .map((person, index) => {
                    return (
                      <div
                        key={"member-" + person.data.M.last.S}
                        onClick={() => handleAdd(person)}
                        className="border flex no-wrap p-1 cursor-pointer space-between"
                      >
                        <div className="w-full flex no-wrap">
        ...
        return (
          ...
          >
            <div className="my-auto">
              <p className="text-lg px-2 font-bold">{project.title.S}</p>
            </div>
