        ...
        <div className="p-4 py-12 sm:p-8 sm:py-24 md:px-16 lg:py-48">
          ...
          >
            <div className="mx-auto max-w-xl md:mx-0">
              <div className="flex">
                ...
                <div>
                  <p className="mx-auto text-center font-lato text-xl font-light leading-tight text-gray-800 dark:text-gray-400 sm:text-2xl md:text-left md:text-3xl lg:text-4xl">
          ...
          >
            <div className="max-w-3xl">
              ...
              <div className="dark:bg-dark-surface mt-6 rounded-r-lg border-l-4 border-tiffany-blue bg-gray-50 p-4 shadow-sm sm:mt-8 sm:p-6">
